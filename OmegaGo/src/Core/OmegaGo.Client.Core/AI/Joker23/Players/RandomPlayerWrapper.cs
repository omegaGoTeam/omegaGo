...
namespace OmegaGo.Core.AI.Joker23.Players
{
    public class RandomPlayerWrapper : AiProgramBase
    {
        ...
        public override string Description => "This AI plays random moves while the board is not empty. I dare you to let two Fish play against each other. The game will never end (unless you're very lucky).";
